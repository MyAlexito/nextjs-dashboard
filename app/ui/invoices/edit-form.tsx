...
import { updateInvoice, State } from '@/app/lib/actions'; // importa la acción del servidor
...
export default function EditInvoiceForm({
  ...
  // PASO CLAVE: crea una función con el ID ya incluido
  const updateInvoiceWithId = updateInvoice.bind(null, invoice.id);

  // Usar useActionState para manejar el estado de la acción y los errores
